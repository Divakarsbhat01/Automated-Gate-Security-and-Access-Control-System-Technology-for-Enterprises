...
public class test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        section= intent.getStringExtra("sec");
        l_view1 = findViewById(R.id.lvx);
        ...
        mref1.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    Log.v("ud","dd"+ud);
                    if(snapshot.child("section").getValue().equals(section)){
                        Log.v("section","data"+snapshot.child("section").getValue().equals(section));
                        ...
                        Myadaptr myadaptr=new Myadaptr(test.this,mList);
                        l_view1.setAdapter(myadaptr);
